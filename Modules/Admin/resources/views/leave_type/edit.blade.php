...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Edit Leave Type</h3>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Update Leave Type</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.leaveType.update', $leave_type->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('days') is-invalid @enderror"
                                   id="days" name="days"
                                   value="{{ old('days', $leave_type->days) }}" required min="1">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('status', $leave_type->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $leave_type->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
