        ...
        <div class="container">
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                    ...
                    <form action="{{route('admin.permissionStore')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="title" class="form-label">Permission Namm</label>
                                <input type="text" class="form-control text-lowercase" id="name" name="name" placeholder="Permission Name" required>
                                @error('name')
