        ...
        <div class="container">
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                    ...
                    <form action="{{route('admin.roleUpdate',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="title" class="form-label">Role Namm</label>
                                <input type="text" class="form-control text-lowercase" id="name" name="name" placeholder="Role Name" value="{{ $data->name }}" required>
                                @error('name')
