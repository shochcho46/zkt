            ...
            <div class="row"> <!--begin::Col-->
                ...
                <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                    <div class="small-box text-bg-success">
                        <div class="inner">
                            {{-- <h3>{{ $totalRecords }} <sup class="fs-5">%</sup> </h3> --}}
                            <h3>{{ $totalRecords }}</h3>
                        ...
                        <div class="col-lg-12 col-12 position-relative">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-12 text-center">
                                        ...
                                        <div id="connectionResponse" class="mt-3"></div>

                                        <div class="d-flex flex-column align-items-center">
                                            <img id="imgload" src="{{ asset('assets/zkt/find.png') }}" alt="find.png" class="img-fluid mb-3 mt-5">
                                            <button id="checkConnectionBtn" class="btn btn-primary mt-3"> <i class="mdi mdi-connection"></i> Check Connection</button>
                                        </div>
...
<script src="https://cdn.jsdelivr.net/npm/jsvectormap@1.5.3/dist/js/jsvectormap.min.js" integrity="sha256-/t1nN2956BT869E6H4V1dnt0X5pAQHPytli+1nTZm2Y=" crossorigin="anonymous"></script>
    ...
    $('#checkConnectionBtn').on('click', function () {
        ...
        $('#connectionResponse').html(''); // Clear previous view

        $.ajax({
            url: '{{ route("admin.connection") }}',
            method: 'GET',
            success: function (response) {
                $('#connectionOverlay').hide();
                $('#imgload').hide();
                $('#connectionResponse').html(response.view); // Inject rendered view
            },
            error: function () {
                $('#connectionOverlay').hide();
                $('#connectionResponse').html('<div class="alert alert-danger">Something went wrong.</div>');
            }
        });
    });
</script>
